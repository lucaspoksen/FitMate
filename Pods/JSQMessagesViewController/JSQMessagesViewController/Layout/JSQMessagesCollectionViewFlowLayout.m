...
const CGFloat kJSQMessagesCollectionViewAvatarSizeDefault = 60.0f;
...
- (CGSize)sizeForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (finalHeight < kJSQMessagesCollectionViewAvatarSizeDefault * 1.1f)
        finalHeight = kJSQMessagesCollectionViewAvatarSizeDefault * 1.1f;
